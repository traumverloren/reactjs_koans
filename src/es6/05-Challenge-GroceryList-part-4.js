...
class GroceryList extends React.Component {
  ...
  render() {
    ...
    clearListButton = React.createElement("button", {className: "clear-list", onClick: this.clearList}, "Clear the List");
...
class GroceryListItem extends React.Component {
  ...
  render() {
    ...
    return (
      React.createElement("li", {className: completed, onClick: this.props.onComplete}, 
